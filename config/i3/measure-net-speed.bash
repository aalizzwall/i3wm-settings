...
enp2s0f1="/sys/devices/pci0000:00/0000:00:1c.0/0000:02:00.1/net/enp2s0f1/statistics"
#enp0s20f0u4="/sys/devices/pci0000:00/0000:00:14.0/usb1/1-4/1-4:1.0/net/enp0s20f0u4/statistics"
wlp3s0="/sys/devices/pci0000:00/0000:00:1c.5/0000:03:00.0/net/wlp3s0/statistics"
#"/sys/devices/pci0000:00/0000:00:14.0/usb1/1-4/1-4:1.0/net/enp0s20f0u4/statistics"

read enp2s0f1_rx < "${enp2s0f1}/rx_bytes"
read enp2s0f1_tx < "${enp2s0f1}/tx_bytes"
#read enp0s20f0u4_rx < "${enp0s20f0u4}/rx_bytes"
#read enp0s20f0u4_tx < "${enp0s20f0u4}/tx_bytes"
read wlp3s0_rx < "${wlp3s0}/rx_bytes"
read wlp3s0_tx < "${wlp3s0}/tx_bytes"

# get time and sum of rx/tx for combined display
time=$(date +%s)
#rx=$(( $enp2s0f1_rx + $wlp3s0_rx + $enp0s20f0u4_rx))
#tx=$(( $enp2s0f1_tx + $wlp3s0_tx + $enp0s20f0u4_tx))
rx=$(( $enp2s0f1_rx + $wlp3s0_rx ))
tx=$(( $enp2s0f1_tx + $wlp3s0_tx ))
